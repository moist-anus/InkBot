...
namespace NadekoBot.Modules.Gambling
{
    internal class DiceRollCommand : DiscordCommand
    {
        ...
        private Image GetDice(int num) => num != 10
                                          ? Inkbot.Properties.Resources.ResourceManager.GetObject("_" + num) as Image
                                          : new[]
                                            {
                                              (Inkbot.Properties.Resources.ResourceManager.GetObject("_" + 1) as Image),
                                              (Inkbot.Properties.Resources.ResourceManager.GetObject("_" + 0) as Image),
                                            }.Merge();
