        ...
        private Func<CommandEventArgs, Task> DrawCardFunc() => async (e) =>
        {
            ...
            try
            {
                ...
                if (!isParsed || num < 2)
                {
                    ...
                    await e.Channel.SendFile(c.Name + ".jpg", (Inkbot.Properties.Resources.ResourceManager.GetObject(c.Name) as Image).ToStream()).ConfigureAwait(false);
                    return;
                }
                if (num > 5)
                    num = 5;
                ...
                for (var i = 0; i < num; i++)
                {
                    ...
                    images.Add(Inkbot.Properties.Resources.ResourceManager.GetObject(currentCard.Name) as Image);
                }
